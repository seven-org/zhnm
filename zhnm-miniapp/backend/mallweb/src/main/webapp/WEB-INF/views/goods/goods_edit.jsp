...
<body class="no-skin">
	...
	<script type="text/javascript">
		function delimg(id) {
		    ...
		    document.getElementById("filepath").value = totalImg;	
		}
		$(function(){
			$('#attr').click(function(){
...
function setValue(ImgValues,k){
	//ImgValues 是刚上传的图片地址sggggs
	var totalImg = "";
    $(".icList").each(function(i,l){
        totalImg = totalImg + $(l).attr('src') + ",";
      });
     if(totalImg !=""){
    	 ...
    	 document.getElementById("filepath").value = ImgValues;
     }
