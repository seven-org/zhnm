					...
					<form action="market/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="market_name" id="market_name" value="${pd.MARKET_NAME}" maxlength="255" placeholder="这里输入优惠券名称" title="优惠券名称" style="width:98%;"/></td>
							</tr>
							<tr>  
								<td style="width:75px;text-align: right;padding-top: 13px;">所在省:</td>
								<td><input type="text" name="market_province" id="market_province" value="${pd.MARKET_PROVINCE}" maxlength="255" placeholder="这里输入优惠券价格" title="优惠券价格" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">所在市:</td>
								<td><input type="text" name="market_city" id="market_city" value="${pd.MARKET_CITY}" maxlength="255" placeholder="这里输入订单金额满多少可以使用优惠券" title="使用额度" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">所在区:</td>
								<td><input type="text" name="market_district" id="market_district" value="${pd.MARKET_DISTRICT}" step="1" maxlength="255" placeholder="这里输入兑换码" title="兑换码" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">详细地址:</td>
								<td><input type="text" name="market_address" id="market_address" value="${pd.MARKET_ADDRESS}" maxlength="32" placeholder="这里输入优惠券数量" title="优惠券数量" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">经纬度:</td>
								<td><input type="text" name="market_coords" id="market_coords" value="${pd.MARKET_COORDS}" maxlength="32" placeholder="这里输入优惠券数量" title="优惠券数量" style="width:98%;"/></td>
							</tr>
