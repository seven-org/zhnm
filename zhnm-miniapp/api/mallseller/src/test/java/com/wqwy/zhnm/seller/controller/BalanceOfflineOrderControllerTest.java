...
//    	b8f5fcc6e4e24b6a807905037e23911e
    	...
    	boowgr.setSellerId("15");
    	boowgr.setBalanceId("68");
//    	boowgr.setPayWay("3");
    	boowgr.setPayWay("2");
...
//    	boogc1.setGoodsId("5");
    	boogc1.setGoodsCount("69.44");
    	boogc1.setGoodsSort("3");
    	boogc1.setGoodsPrice("3.356");
    	BalanceOfflineOrderGoodsComponent boogc2 = new BalanceOfflineOrderGoodsComponent();
    	boogc2.setGoodsId("6");
    	boogc2.setGoodsCount("3.35");
    	boogc2.setGoodsSort("4");
    	boogc2.setGoodsPrice("369.35");
    	BalanceOfflineOrderGoodsComponent boogc3 = new BalanceOfflineOrderGoodsComponent();
    	boogc3.setGoodsId("7");
    	boogc3.setGoodsCount("52.30");
    	boogc3.setGoodsSort("5");
    	BalanceOfflineOrderGoodsComponent boogc4 = new BalanceOfflineOrderGoodsComponent();
    	boogc4.setGoodsId("8");
    	boogc4.setGoodsCount("33.66");
    	boogc4.setGoodsSort("7");
    	BalanceOfflineOrderGoodsComponent boogc5 = new BalanceOfflineOrderGoodsComponent();
    	boogc5.setGoodsId("11");
    	boogc5.setGoodsCount("193.39");
    	boogc5.setGoodsSort("9");
    	boogcList.add(boogc1);
    	boogcList.add(boogc2);
    	boogcList.add(boogc3);
    	boogcList.add(boogc4);
    	boogcList.add(boogc5);
