...
public class FinishOnlineOrderJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		shopOrder.setStatus(DefaultConstants.ShopOrderEnum.SHOPORDER_FINISHED.getShopOrderEnum());
		shopOrderService.updateForJob(shopOrder);
		ShopOrderDetail sod = new ShopOrderDetail();
		sod.setOrderId(shopOrderId);
		sod.setStatus(DefaultConstants.ShopOrderEnum.SHOPORDER_FINISHED.getShopOrderEnum());
