...
Page({
  ...
  onLoad: function (options) {
    ...
    // wx.request({
    //   url: app.data.httpserver + 'app/goodslist',
    ...
    var data = { category_id: category_id, super_id: super_id, gtui: gtui, gsales: gsales, gprice: gprice, goods_name: goods_name, currentPage: currentPage }
